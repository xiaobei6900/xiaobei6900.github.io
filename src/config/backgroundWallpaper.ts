...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		// 桌面背景图片（支持单张或多张随机）
		desktop: "assets/images/DesktopWallpaper/silverwolf-d1.avif",
		// 移动背景图片（支持单张或多张随机）
		mobile: "assets/images/MobileWallpaper/silverwolf-m1.avif",
		// 背景视频播放地址
			...
			links: [
				{
					...
					url: "https://github.com/xiaobei6900",
					showName: true,
				},
				{
					name: "RSS",
	...
	banner: {
		...
		// 横幅壁纸模式下人物偏右，左下留白给标题，取景略偏下以保留头部
		position: "center 30%",
